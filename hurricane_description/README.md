...
```bash
cd ~/ros2_ws
colcon build --packages-up-to hurricane_description --symlink-install
```
...
ros2 launch hurricane_description visualize.launch.py
```
...
* RL Quadruped Controller
  ```bash
  source ~/ros2_ws/install/setup.bash
  ros2 launch hurricane_description gazebo_rl_control.launch.py
  ```
